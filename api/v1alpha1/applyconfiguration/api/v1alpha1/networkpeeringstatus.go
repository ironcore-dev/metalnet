...
type NetworkPeeringStatusApplyConfiguration struct {
	...
	State *apiv1alpha1.NetworkPeeringState `json:"state,omitempty"`
}
...
func (b *NetworkPeeringStatusApplyConfiguration) WithState(value apiv1alpha1.NetworkPeeringState) *NetworkPeeringStatusApplyConfiguration {
	b.State = &value
	return b
}
