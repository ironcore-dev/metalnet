...
func (r *NetworkReconciler) reconcile(ctx context.Context, log logr.Logger, network *metalnetv1alpha1.Network) (ctrl.Result, error) {
	...
	if network.Spec.PeeredIDs != nil {
		...
		if err := r.reconcilePeeredVNIs(ctx, network, vni); err != nil {
			return ctrl.Result{}, err
		}
...
func (r *NetworkReconciler) reconcilePeeredVNIs(ctx context.Context, network *metalnetv1alpha1.Network, vni uint32) error {
